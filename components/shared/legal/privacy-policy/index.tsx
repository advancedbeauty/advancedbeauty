      ...
      <Container className="w-full flex flex-col gap-10 mb-10">
        <div>
          ...
          <p className="mt-5 font-medium">
            ...
            <Link
              href="https://www.advancedbeauty.in"
              className="text-blue-600 underline font-semibold"
            >
              www.advancedbeauty.in
            </Link>
            , we prioritize the privacy of our clients. This Privacy Policy
            outlines the types of personal information we collect, how we use
            it, and the measures we take to protect your information. By using
            our website and services, you consent to the data practices
        ...
        <ul className="pl-7 md:pl-10 lg:pl-16 list-decimal flex flex-col gap-7">
          <li className="font-bold text-xl">
            ...
            <ul className="list-disc pl-4 font-normal text-base gap-1 flex flex-col mt-1">
              ...
              <li>
                ...
                billing address (processed through secure third-party payment
                gateways).
              </li>
              <li>
                <strong>Appointment Details:</strong> Preferences, service
                selections, and any other relevant information related to your
                service.
              </li>
            </ul>
          </li>
          <li className="font-bold text-xl">
            ...
            <ul className="list-disc pl-4 font-normal text-base gap-1 flex flex-col mt-1">
              <li>
                <strong>To Provide Services:</strong> To process your
                appointments, manage your bookings, and deliver our beauty
                services.
              </li>
              <li>
                <strong>To Communicate:</strong> To send you confirmations,
                reminders, and updates related to your appointments.
              </li>
              <li>
                <strong>To Improve Our Services:</strong> To analyze user
                behavior and preferences to enhance our offerings.
              </li>
              <li>
                <strong>For Marketing:</strong> With your consent, to send you
                promotional materials and newsletters about our services and
                offers.
              </li>
            </ul>
          </li>
          <li className="font-bold text-xl">
            ...
            <ul className="list-disc pl-4 font-normal text-base gap-1 flex flex-col mt-1">
              <li>
                ...
                implement a variety of security measures, including encryption
                and secure servers, to protect your personal data from
          ...
          <li className="font-bold text-xl">
            ...
            <ul className="list-disc pl-4 font-normal text-base gap-1 flex flex-col mt-1">
              <li>
                ...
                small files stored on your device that help us analyze web
                traffic and improve our site. You can choose to accept or
                decline cookies, but this may prevent you from taking full
